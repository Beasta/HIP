...
Beaconing, regardless of reward structures allows the eliminination of Multi-hop PoC.  Multihop PoC is significantly more complex than beaconing requiring complex path building and path verification, 
